    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        ...
        >
          ...
          <h1 className="text-3xl md:text-4xl font-serif mb-3">Welcome to Brief AI</h1>
          <p className="text-muted-foreground mb-8">
            Sign in with your Google account to create and manage your personalized cultural scouts.
          </p>
